...
The mathematical work of Maryam Mirzakhani constitutes a systematic synthesis of hyperbolic geometry, complex analysis, topology, and dynamical systems. Her research is characterized by a geometric approach that reformulates complex algebraic and counting problems into global questions regarding the topology and geometry of moduli spaces. Her early research culminated in her 2007 papers on Weil-Petersson volumes, establishing the foundation for her later work on the moduli spaces of bordered Riemann surfaces (\cite{Mirzakhani2007a, Mirzakhani2007b}). 
...
\begin{equation}
    \lim_{L\to\infty} \frac{s_X(L)}{L^{6g-6}} = c_X. \footnote{The constant $c_X$ depends on the hyperbolic structure of $X$ and is expressed as an explicit Weil–Petersson integral: $c_X = \int_{\mathcal{M}_g} f_X \, \omega_{WP}^{3g-3}$, where $f_X$ is the frequency function introduced in Mirzakhani’s 2007 \textit{Inventiones Mathematicae} paper. This identity ties the counting of geodesics on a single surface directly to the volume geometry of the moduli space $\mathcal{M}_g$.}
\end{equation}
where the exponent $6g-6$ corresponds to the dimension of the relevant Teichmüller space $\mathcal{T}_g$. This result demonstrates that the density of simple geodesics is governed by the average behavior of these curves across the entire moduli space, establishing a rigorous link between individual surface geometry and global volume geometry.
...
The recursive framework for Weil--Petersson volumes provided a new approach to a central problem in enumerative geometry and string theory. In 1991, Edward Witten conjectured that the intersection numbers of tautological classes on the Deligne--Mumford compactification of the moduli space, $\overline{\mathcal{M}}_{g,n}$, are governed by the Korteweg-de Vries (KdV) hierarchy. 
...
Mirzakhani demonstrated that her recursive volume formula is equivalent to the Virasoro constraints, which in turn imply the KdV integration hierarchy.\footnote{By applying a multi-dimensional Laplace transform to the volume polynomials, Mirzakhani obtained a generating function that satisfies the same recursive relations as the tau-function of the KdV hierarchy. This established a direct link between the hyperbolic geometry of $\mathcal{M}_{g,n}$ and the integrable systems of mathematical physics \cite{Mirzakhani2007b}.} This result provided a transparent geometric interpretation of quantities previously understood primarily through combinatorial or physical intuitions.

\subsection{Dynamics on Moduli Spaces: The "Magic Wand" Theorem}

In the later stages of her career, Mirzakhani's research shifted from the static geometry of moduli spaces to the dynamics of translation surfaces and rational billiards. This field centers on the ergodic properties of flows on surfaces: specifically, whether long-term trajectories equidistribute across the available space or remain confined to complex, fractal sets. 
...
They established a fundamental rigidity theorem, proving that orbit closures are not pathological fractal sets but are instead highly structured algebraic objects.
...
This result, colloquially known as the ``Magic Wand'' theorem, implies that these orbit closures are locally defined by linear equations with real coefficients in period coordinates.\footnote{The theorem represents an analogue of Ratner’s theorems for unipotent flows on homogeneous spaces, but applied to the much more complex setting of non-homogeneous moduli spaces. For the complete proof and its implications for the illumination problem in rational polygons, see \cite{EskinMirzakhaniMohammadi2015}.} The theorem provides a definitive constraint on the dynamical behavior of translation surfaces, eliminating the possibility of infinitely complex or chaotic orbit geometries.
...
\end{equation}
where $C$ is a universal constant.\footnote{For the detailed derivation of the $g^{2g}$ growth rate and the precise constants involved in the large-genus limit, see Mirzakhani (2013) \cite{Mirzakhani2013}. This result characterizes the statistical properties of "typical" hyperbolic surfaces of high genus.} This research direction provides a bridge between the enumerative geometry of moduli spaces and the spectral theory of large-order random surfaces.
